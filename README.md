...
* Rui Fan, Ming Liu, Road Damage Detection Based on Unsupervised Disparity Map Segmentation, IEEE Transactions on Intelligent Transportation Systems (T-ITS), pp. 1-6, November 2019. <object data="http://yoursite.com/the.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="http://yoursite.com/the.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="http://yoursite.com/the.pdf">Download PDF</a>.</p>
    </embed>
</object>[{< pdf "/papers/fan2019road.pdf" >}] [{< bib "/papers/fan2019road_damage.bib" >}]
