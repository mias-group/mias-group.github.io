...
* Rui Fan, Ming Liu, Road Damage Detection Based on Unsupervised Disparity Map Segmentation, IEEE Transactions on Intelligent Transportation Systems (T-ITS), pp. 1-6, November 2019. [embed]"/papers/fan2019road.pdf"[/embed][{< pdf "/papers/fan2019road.pdf" >}] [{< bib "/papers/fan2019road_damage.bib" >}]
